    ...
    <article className="product-card group flex flex-col overflow-hidden rounded-xl border border-gray-100 bg-white shadow-sm transition-all hover:shadow-xl">
      ...
      <div className="flex flex-1 flex-col px-3 py-5 text-center sm:px-5">
        ...
        <div className="mt-auto">
          ...
          <Link
            href={productHref}
            className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg border border-primary bg-white py-2.5 text-[11px] font-bold uppercase tracking-wider text-primary transition-all hover:bg-red-500 hover:text-white"
          >
            Chọn mua
          </Link>
        </div>
